...
package com.blackberry.ex.photo.fragments;
...
import com.blackberry.ex.photo.Intents;
import com.blackberry.ex.photo.PhotoViewCallbacks;
import com.blackberry.ex.photo.PhotoViewCallbacks.CursorChangedListener;
import com.blackberry.ex.photo.PhotoViewCallbacks.OnScreenListener;
import com.blackberry.lib.photoviewer.R;
import com.blackberry.ex.photo.adapters.PhotoPagerAdapter;
import com.blackberry.ex.photo.loaders.PhotoBitmapLoaderInterface.BitmapResult;
import com.blackberry.ex.photo.loaders.PhotoBitmapLoaderInterface;
import com.blackberry.ex.photo.util.ImageUtils;
import com.blackberry.ex.photo.views.PhotoView;
import com.blackberry.ex.photo.views.ProgressBarWrapper;
...
public class PhotoViewFragment extends Fragment implements
    ...
    protected final static String STATE_INTENT_KEY =
            "com.blackberry.mail.photo.fragments.PhotoViewFragment.INTENT";
