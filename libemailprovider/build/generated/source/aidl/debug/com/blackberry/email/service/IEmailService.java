 ...
 * Original file: /Users/gofu/AndroidStudioProjects/CantoneseChallenge/libemailprovider/src/main/aidl/com/blackberry/email/service/IEmailService.aidl
 */
package com.blackberry.email.service;
public interface IEmailService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.blackberry.email.service.IEmailService
{
private static final java.lang.String DESCRIPTOR = "com.blackberry.email.service.IEmailService";
...
/**
 * Cast an IBinder object into an com.blackberry.email.service.IEmailService interface,
 * generating a proxy if needed.
 */
public static com.blackberry.email.service.IEmailService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.blackberry.email.service.IEmailService))) {
return ((com.blackberry.email.service.IEmailService)iin);
}
return new com.blackberry.email.service.IEmailService.Stub.Proxy(obj);
}
...
com.blackberry.email.provider.contract.HostAuth _arg0;
if ((0!=data.readInt())) {
_arg0 = com.blackberry.email.provider.contract.HostAuth.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.blackberry.email.service.IEmailServiceCallback _arg0;
_arg0 = com.blackberry.email.service.IEmailServiceCallback.Stub.asInterface(data.readStrongBinder());
long _arg1;
_arg1 = data.readLong();
boolean _arg2;
...
java.lang.String _arg1;
_arg1 = data.readString();
this.deleteAccountPIMData(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
long _arg0;
_arg0 = data.readLong();
com.blackberry.email.service.SearchParams _arg1;
if ((0!=data.readInt())) {
_arg1 = com.blackberry.email.service.SearchParams.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.blackberry.email.provider.contract.Account _arg0;
if ((0!=data.readInt())) {
_arg0 = com.blackberry.email.provider.contract.Account.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
private static class Proxy implements com.blackberry.email.service.IEmailService
{
...
@Override public android.os.Bundle validate(com.blackberry.email.provider.contract.HostAuth hostauth) throws android.os.RemoteException
{
...
@Override public void loadAttachment(com.blackberry.email.service.IEmailServiceCallback cb, long attachmentId, boolean background) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void deleteAccountPIMData(long accountId, java.lang.String emailAddress) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int searchMessages(long accountId, com.blackberry.email.service.SearchParams params, long destMailboxId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int getCapabilities(com.blackberry.email.provider.contract.Account acct) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public android.os.Bundle validate(com.blackberry.email.provider.contract.HostAuth hostauth) throws android.os.RemoteException;
...
public void loadAttachment(com.blackberry.email.service.IEmailServiceCallback cb, long attachmentId, boolean background) throws android.os.RemoteException;
...
public void deleteAccountPIMData(long accountId, java.lang.String emailAddress) throws android.os.RemoteException;
public int getApiLevel() throws android.os.RemoteException;
// API level 2

public int searchMessages(long accountId, com.blackberry.email.service.SearchParams params, long destMailboxId) throws android.os.RemoteException;
public void sendMail(long accountId) throws android.os.RemoteException;
// API level 3

public int getCapabilities(com.blackberry.email.provider.contract.Account acct) throws android.os.RemoteException;
