...
import com.blackberry.common.Device;
...
public class EmailServiceProxy extends ServiceProxy implements IEmailService {
    ...
    public static final String VALIDATE_BUNDLE_ACCOUNT_CAPABILITIES = "validate_account_capabilities";
    ...
    */
     ...
     *
     * @param accountId the accound id for the account whose data should be deleted
     * @param emailAddress the email address for the account whose data should be deleted
     */
    @Override
    public void deleteAccountPIMData(final long accountId, final String emailAddress) throws RemoteException {
        setTask(new ProxyTask() {
            @Override
            public void run() throws RemoteException {
                mService.deleteAccountPIMData(accountId, emailAddress);
            }
