...
public abstract class ServiceProxy {
     ...
     * Package com.blackberry.email + ACTION -> com.blackberry.email.ACTION
     * Package com.google.android.email + ACTION -> com.google.blackberry.email.ACTION
     * Package com.blackberry.eas + ACTION -> com.blackberry.email.ACTION
    ...
    public boolean test() {
        try {
            ...
            LogUtils.v(mTag,"connection test failure " + e.getMessage());
