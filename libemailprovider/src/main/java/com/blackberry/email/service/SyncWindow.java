...
public class SyncWindow {
    ...
    public static final int SYNC_WINDOW_COUNT10 = 10;
    public static final int SYNC_WINDOW_COUNT20 = 20;
    public static final int SYNC_WINDOW_COUNT50 = 50;
    public static final int SYNC_WINDOW_COUNT100 = 100;
    ...
    public static int toCount(int count) {
        switch(count) {
            case SYNC_WINDOW_COUNT10:
                return 10;
            case SYNC_WINDOW_COUNT20:
                return 20;
            case SYNC_WINDOW_COUNT50:
                return 50;
            case SYNC_WINDOW_COUNT100:
                return 100;
            case SYNC_WINDOW_ALL:
                return 10000;
            default:
