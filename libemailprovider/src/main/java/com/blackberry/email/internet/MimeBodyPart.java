...
import com.blackberry.email.mail.Body;
import com.blackberry.email.mail.BodyPart;
...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof com.blackberry.email.mail.Multipart) {
            com.blackberry.email.mail.Multipart multipart =
                ((com.blackberry.email.mail.Multipart)body);
