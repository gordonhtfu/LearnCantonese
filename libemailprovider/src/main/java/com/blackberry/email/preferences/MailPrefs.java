...
//import com.blackberry.mail.widget.BaseWidgetProvider;
...
public final class MailPrefs extends VersionedPrefs {
    ...
    //@NOTE removed BaseWidgetProvider dep **MFL
    ...
    private static String createWidgetPreferenceValue(Account account, String folderUri) {
        return account.uri.toString() + ACCOUNT_FOLDER_PREFERENCE_SEPARATOR
                + folderUri;
