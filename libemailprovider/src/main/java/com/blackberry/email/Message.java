...
import com.blackberry.email.provider.EmlAttachmentProvider;
import com.blackberry.email.provider.UIProvider;
import com.blackberry.email.provider.UIProvider.MessageColumns;
import com.blackberry.email.ui.HtmlMessage;
import com.blackberry.email.utils.ConversionUtilities;
import com.blackberry.email.internet.MimeMessage;
import com.blackberry.email.internet.MimeUtility;
//import com.blackberry.mail.utils.UtilsEx;
...
//            eventIntentUri =
//                    .getValidUri(cursor.getString(UIProvider.MESSAGE_EVENT_INTENT_COLUMN));
            spamWarningString =
    ...
    public Message(Context context, MimeMessage mimeMessage, Uri emlFileUri)
        ...
        setFrom(com.blackberry.email.mail.Address.pack(mimeMessage.getFrom()));
        setTo(com.blackberry.email.mail.Address.pack(mimeMessage.getRecipients(
                com.blackberry.email.mail.Message.RecipientType.TO)));
        setCc(com.blackberry.email.mail.Address.pack(mimeMessage.getRecipients(
                com.blackberry.email.mail.Message.RecipientType.CC)));
        setBcc(com.blackberry.email.mail.Address.pack(mimeMessage.getRecipients(
                com.blackberry.email.mail.Message.RecipientType.BCC)));
        setReplyTo(com.blackberry.email.mail.Address.pack(mimeMessage.getReplyTo()));
