...
import com.blackberry.email.provider.UIProvider.AccountColumns;
import com.blackberry.email.provider.UIProvider.SyncStatus;
...
public class Account implements Parcelable {
    ...
    private Account(String acctName, String acctType, String jsonAccount) throws JSONException {
        ...
        quickResponseUri = Utility.getValidUri(json.optString(AccountColumns.QUICK_RESPONSE_URI));
    ...
    public Account(Cursor cursor) {
        ...
        composeIntentUri = Utility.getValidUri(
        ...
        recentFolderListUri = Utility.getValidUri(cursor.getString(
        ...
        quickResponseUri = Utility.getValidUri(cursor.getString(
    ...
    public boolean isAccountSyncRequired() {
        ...
        return false;//(syncStatus & SyncStatus.INITIAL_SYNC_NEEDED) == SyncStatus.INITIAL_SYNC_NEEDED;
    }
