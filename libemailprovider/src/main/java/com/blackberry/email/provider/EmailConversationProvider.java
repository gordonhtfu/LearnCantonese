...
import com.blackberry.email.ui.browse.ConversationCursor.ConversationProvider;
...
public class EmailConversationProvider extends ConversationProvider {
    ...
    private static final String sAuthority = "com.blackberry.email.conversation.provider";
