...
import com.blackberry.email.provider.UIProvider.AutoAdvance;
import com.blackberry.email.provider.UIProvider.ConversationListIcon;
import com.blackberry.email.provider.UIProvider.DefaultReplyBehavior;
import com.blackberry.email.provider.UIProvider.MessageTextSize;
import com.blackberry.email.provider.UIProvider.SnapHeaderValue;
import com.blackberry.email.provider.UIProvider.Swipe;
import com.blackberry.email.provider.UIProvider.AccountColumns.SettingsColumns;
...
public class Settings implements Parcelable {
    ...
    public Settings(Parcel inParcel) {
        ...
        defaultInbox = Utility.getValidUri(inParcel.readString());
        ...
        setupIntentUri = Utility.getValidUri(inParcel.readString());
        conversationViewMode = inParcel.readInt();
        veiledAddressPattern = inParcel.readString();
        moveToInbox = Utility.getValidUri(inParcel.readString());
    }
    ...
    public Settings(Cursor cursor) {
        ...
        defaultInbox = Utility.getValidUri(
        ...
        setupIntentUri = Utility.getValidUri(
        ...
        moveToInbox = Utility.getValidUri(
    ...
    private Settings(JSONObject json) {
        ...
        defaultInbox = Utility.getValidUri( json.optString(SettingsColumns.DEFAULT_INBOX));
        ...
        setupIntentUri = Utility.getValidUri(json.optString(SettingsColumns.SETUP_INTENT_URI));
        ...
        moveToInbox = Utility.getValidUri(json.optString(SettingsColumns.MOVE_TO_INBOX));
    }
