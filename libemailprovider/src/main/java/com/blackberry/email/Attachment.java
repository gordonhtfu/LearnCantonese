...
import com.blackberry.email.provider.UIProvider.AttachmentType;
...
public class Attachment implements Parcelable {
    ...
    public Uri getIdentifierUri() {
        if (Utility.isEmpty(mIdentifierUri)) {
            mIdentifierUri = Utility.isEmpty(uri) ?
                    (Utility.isEmpty(contentUri) ? Uri.EMPTY : contentUri)
