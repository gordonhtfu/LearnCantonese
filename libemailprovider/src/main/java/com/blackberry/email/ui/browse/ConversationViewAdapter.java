...
import com.blackberry.email.ui.browse.MessageHeaderView.MessageHeaderViewCallbacks;
import com.blackberry.email.ui.browse.SuperCollapsedBlock.OnClickListener;
...
public class ConversationViewAdapter extends BaseAdapter {
    ...
    public static class MessageHeaderItem extends ConversationOverlayItem {
        ...
        private void ensureTimestamps() {
            if (mMessage.mTimeStamp != mTimestampMs) {
                mTimestampMs = mMessage.mTimeStamp;
