...
package com.blackberry.email.ui.photo;
...
import com.blackberry.ex.photo.PhotoViewActivity;
import com.blackberry.ex.photo.fragments.PhotoViewFragment;
...
import com.blackberry.email.ui.browse.AttachmentActionHandler;
...
public class MailPhotoViewActivity extends PhotoViewActivity {
    ...
    protected void updateActionItems() {
        final boolean runningJellyBeanOrLater = UtilsEx.isRunningJellybeanOrLater();
    ...
    protected void updateActionBar() {
        ...
        final String size = AttachmentUtilities.convertToHumanReadableSize(this, attachment.size);
    ...
    private void shareAllAttachments() {
        ...
        int i = -1;
        while (cursor.moveToPosition(++i)) {
            uris.add(UtilsEx.normalizeUri(new Attachment(cursor).contentUri));
        }
