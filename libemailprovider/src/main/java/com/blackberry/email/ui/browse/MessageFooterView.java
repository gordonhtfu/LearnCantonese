...
import com.blackberry.email.ui.browse.AttachmentLoader.AttachmentCursor;
import com.blackberry.email.ui.browse.ConversationContainer.DetachListener;
...
public class MessageFooterView extends LinearLayout implements DetachListener,
    ...
    private Integer getAttachmentLoaderId() {
        Integer id = null;
        /* TODO attachments
        final MessageValue msg = mMessageHeaderItem == null ? null : mMessageHeaderItem.getMessage();
