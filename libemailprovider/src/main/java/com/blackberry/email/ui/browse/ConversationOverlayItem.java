...
public abstract class ConversationOverlayItem {
    ...
    public static final String LOG_TAG = SecureConversationViewFragment.LAYOUT_TAG;
     ...
     * {@link com.blackberry.email.ui.browse.ConversationViewAdapter.BorderItem}
     * to update the height of the border based on whether the neighboring messages
     * are collapsed or expanded.<br><br>
     *
     * It is also used by {@link com.blackberry.email.ui.browse.ConversationViewAdapter.MessageHeaderItem}
     ...
     * {@link com.blackberry.email.ui.browse.ConversationViewAdapter#notifyDataSetChanged()}
