...
//import com.blackberry.mail.ui.Dimensions;
//import com.blackberry.mail.ui.InvalidateCallback;
...
//            todo:markwei do not scale very small bitmaps
    ...
    public void getDesiredDimensions(Object key, Dimensions outDim) {
        UtilsEx.traceBeginSection("get desired dimensions");
        int w = 0, h = 0;
        float scale = 0;
    ...
    private void addOrClearDivisionImage(Bitmap b, Object key) {
        UtilsEx.traceBeginSection("add or clear division image");
        final Integer pos = mDivisionMap.get(transformKeyToDivisionId(key));
        if (pos != null && pos >= 0) {
    ...
    public void setDimensions(int width, int height) {
        UtilsEx.traceBeginSection("set dimensions");
