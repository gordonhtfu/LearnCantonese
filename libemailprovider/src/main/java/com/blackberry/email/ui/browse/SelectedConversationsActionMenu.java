...
import com.blackberry.email.provider.UIProvider.FolderCapabilities;
import com.blackberry.email.provider.UIProvider.FolderType;
import com.blackberry.email.ui.ControllableActivity;
import com.blackberry.email.ui.ConversationListCallbacks;
import com.blackberry.email.ui.ConversationSelectionSet;
import com.blackberry.email.ui.ConversationSetObserver;
...
//import com.blackberry.mail.providers.MailAppProvider;
//import com.blackberry.mail.ui.FolderOperation;
//import com.blackberry.mail.ui.FolderSelectionDialog;
//import com.blackberry.mail.ui.MailActionBarView;
...
//                }
            ...
            new AsyncTask<Void, Void, Folder>() {
                ...
                protected Folder doInBackground(final Void... params) {
                    ...
                    return UtilsEx.getFolder(mContext, mAccount.settings.moveToInbox,
                            true /* allowHidden */);
                }
...
//                            true /* showUndo */, false /* isMoveTo */);
    ...
    private void performDestructiveAction(final int action) {
        ...
        if (showDialog) {
            ...
            final CharSequence message = UtilsEx.formatPlural(mContext, resId, conversations.size());
...
//        unread.setVisible(showMarkUnread);
        ...
        if (!showArchive && accountSupportsArchive) {
            if (!showRemoveFolder &&
                    UtilsEx.shouldShowDisabledArchiveIcon(mActivity.getActivityContext())) {
