...
import com.blackberry.email.FormattedDateBuilder;
import com.blackberry.email.ui.browse.ConversationMessage;
import com.blackberry.email.ui.browse.ConversationViewAdapter;
...
import com.blackberry.email.ui.browse.MessageFooterView;
import com.blackberry.email.ui.browse.MessageHeaderView;
import com.blackberry.email.ui.browse.MessageScrollView;
import com.blackberry.email.ui.browse.MessageWebView;
import com.blackberry.email.utils.ConversationViewUtils;
import com.blackberry.lib.emailprovider.R;

/**
 * Controller to do most of the heavy lifting for {@link SecureConversationViewFragment}
 * and {@link com.blackberry.mail.browse.EmlMessageViewFragment}. Currently that work is
...
public class SecureConversationViewController implements
    ...
    private static final String BEGIN_HTML =
            "<body style=\"margin: 0 %spx;\"><div style=\"margin: 0 0 16px; font-size: 80%%\">";
    ...
    public void renderMessage(ConversationMessage message) {
        ...
        mWebView.getSettings().setBlockNetworkImage(!mMessage.mAlwaysShowImages);
