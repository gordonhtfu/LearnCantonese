...
import com.blackberry.email.ui.browse.ScrollNotifier.ScrollListener;
import com.blackberry.email.utils.DequeMap;
import com.blackberry.email.utils.InputSmoother;
...
public class ConversationContainer extends ViewGroup implements ScrollListener {
    private static final String TAG = SecureConversationViewFragment.LAYOUT_TAG;
