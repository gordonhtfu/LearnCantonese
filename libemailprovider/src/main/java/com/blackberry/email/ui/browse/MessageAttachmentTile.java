...
import com.blackberry.email.provider.UIProvider.AttachmentRendition;
import com.blackberry.email.ui.AttachmentTile;
import com.blackberry.email.ui.AttachmentTileGrid;
import com.blackberry.email.ui.photo.MailPhotoViewActivity;
...
public class MessageAttachmentTile extends AttachmentTile implements OnClickListener,
    ...
    public void thumbnailLoadFailed() {
        ...
        if (AttachmentUtilities.canDownloadAttachment(getContext(), null)) {
