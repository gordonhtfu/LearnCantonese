...
//import com.blackberry.mail.utils.MarkConversationCursorVisibleTask;
...
public class UtilsEx {
    ...
    public static final String ACTION_NOTIFY_DATASET_CHANGED =
            "com.blackberry.mail.ACTION_NOTIFY_DATASET_CHANGED";
    ...
    public static synchronized void getSenderSnippet(String instructions,
        ...
        for (int i = 0; i < numFragments;) {
            ...
            if ("".equals(fragment0)) {
                ...
                senderBuilder.append(UtilsEx.convertHtmlToPlainText(fragments[i++]));
                return;
        ...
        for (int i = 0; i < numFragments;) {
            ...
            if ("".equals(fragment0)) {
                ...
                if (nameString.length() == 0) {
                    ...
                    nameString = UtilsEx.convertHtmlToPlainText(nameString).toString();
                }
    ...
    public static Intent createViewConversationIntent(final Context context,
        ...
        intent.putExtra(UtilsEx.EXTRA_ACCOUNT, account.serialize());
        intent.putExtra(UtilsEx.EXTRA_FOLDER_URI, folderUri);
        intent.putExtra(UtilsEx.EXTRA_CONVERSATION, conversation);
        return intent;
    }
    ...
    public static int getVersionCode(Context context) {
        if (sVersionCode == -1) {
            try {
                ...
                LogUtils.e(UtilsEx.LOG_TAG, "Error finding package %s",
