...
/**
 * A headless Activity which simply calls into the framework {@link KeyChain}
 * service to select a certificate to use for establishing secure connections in
 * the Email app.
 */
public class CertificateRequestor extends Activity implements KeyChainAliasCallback {

    public static final String ACTION_REQUEST_CERT = "com.blackberry.email.REQUEST_CERT";
