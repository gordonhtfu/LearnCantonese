 ...
 */
package com.blackberry.email.account.preferences;
...
import com.blackberry.email.preferences.BasePreferenceMigrator;
        ...
        if (oldVersion < 1) {
            ...
            for (final Account account : accounts) {
                ...
                final Cursor ecAccountCursor = context.getContentResolver().query(
                        ...
                        com.blackberry.email.provider.contract.Account.CONTENT_PROJECTION,
                        AccountColumns.EMAIL_ADDRESS + " = ?", new String[] { account.name },
                        null);
                final com.blackberry.email.provider.contract.Account ecAccount =
                        new com.blackberry.email.provider.contract.Account();
                ...
                final boolean notify = (ecAccount.getFlags()
                        & com.blackberry.email.provider.contract.Account.FLAGS_NOTIFY_NEW_MAIL) != 0;
                ...
                final boolean vibrate = (ecAccount.getFlags()
                        & com.blackberry.email.provider.contract.Account.FLAGS_VIBRATE) != 0;
