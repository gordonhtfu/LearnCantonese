...
import com.blackberry.email.service.ServiceProxy;
import com.blackberry.email.utils.IntentUtilities;
import com.blackberry.email.utils.Utility;
import com.blackberry.lib.emailprovider.R;
import com.blackberry.email.Folder;
import com.blackberry.email.provider.UIProvider.EditSettingsExtras;
...
public class AccountSettings extends PreferenceActivity implements /*FeedbackEnabledActivity,*/
    ...
    private Header mPrioritizationRules;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFeedbackUri = Utility.getValidUri(getString(R.string.email_feedback_uri));
    }
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        target.add(getPrioritizationRulesHeader());
...
//        }
    ...
    /*
     * generate and return priority hub header
     */
    private Header getPrioritizationRulesHeader() {
        if (mPrioritizationRules == null) {
            mPrioritizationRules = new Header();
            mPrioritizationRules.title = getText(R.string.header_label_prioritization_rules);
            mPrioritizationRules.summary = null;
            mPrioritizationRules.iconRes = 0;
            mPrioritizationRules.intent = new Intent("com.blackberry.analytics.PRIORITIZATION_RULES");
        }
        return mPrioritizationRules;
    }
    /**
 ...
 //   @Override  not sure if needed **MFL
